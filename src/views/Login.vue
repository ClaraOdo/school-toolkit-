    ...
    <div class="max-w-md w-full space-y-8">
      <div>
        <h2 class="mt-6 text-center text-3xl font-extrabold text-gray-900">
          School Child Protection Toolkit
        </h2>
      ...
      <form class="mt-8 space-y-6" @submit.prevent="handleLogin">
        ...
        <div class="text-center">
          ...
          <div class="mt-2 space-y-1 text-xs text-gray-500">
            <p>Admin: admin@schoolprotection.ug / password</p>
            <p>Teacher: sarah@kampalaprimary.ug / password</p>
            <p>Social Worker: david@kampalaprimary.ug / password</p>
            <p>Nurse: grace@kampalaprimary.ug / password</p>
          </div>
        </div>
      </form>
    </div>
