  ...
  <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="mb-8">
      <div class="flex items-center justify-between">
        <div>
          <h1 class="text-2xl font-bold text-gray-900">Register New Child</h1>
          <p class="mt-2 text-gray-600">Add a new child to the protection system.</p>
        </div>
        <router-link 
          to="/children" 
    ...
    <form @submit.prevent="handleSubmit" class="space-y-8">
      ...
      <div class="bg-white shadow rounded-lg p-6">
        ...
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
          <div>
            <label for="origin_district" class="block text-sm font-medium text-gray-700">District</label>
            <input
              id="origin_district"
          ...
          <div>
            <label for="origin_sub_county" class="block text-sm font-medium text-gray-700">Sub County</label>
            <input
          ...
          <div>
            <label for="origin_parish" class="block text-sm font-medium text-gray-700">Parish</label>
            <input
              id="origin_parish"
          ...
          <div>
            <label for="origin_village" class="block text-sm font-medium text-gray-700">Village</label>
            <input
              id="origin_village"
...
const handleSubmit = async () => {
  ...
  try {
    const response = await childrenAPI.create(form)
    
    // Success - redirect to children list
    router.push('/children')
  } catch (err) {
    console.error('Error creating child:', err)
    error.value = err.response?.data?.message || 'Failed to register child. Please try again.'
  } finally {
    loading.value = false
  }
}
